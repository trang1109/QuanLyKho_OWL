...
<body>
    ...
    <?php include('partials/if-main.php')?>
        <div class="dashboard_content_container" id="dashboard_content_container">
            ...
            <div class="title">
                <h1>Phiếu Điều Phối Lô Nguyên Vật Liệu</h1>
            </div>
            <div class="dashboard_content">
                <div class="row-add">
                    ...
                    <div class="column-add column-7">
                        <h2>Danh sách lô hàng nguyên vật liệu cần điều phối</h2>
                        <div class="user">
                            <table >
                                <thead>
                                    <tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Điều phối lô hàng nguyên vật liệu vào kho</h5>
                            ...
                            <p class="userCount"><?php echo count($los) ?> Lô hàng nguyên vật liệu nhập</p>
                            
                        </div>
                        
                    </div>
                    <div class="column-add column-7">
                        <h2>Danh sách lô hàng đã điều phối</h2>
                        <div class="user">
                            <table>
                                <thead>
                                    <tr>
                            ...
                            <p class="userCount"><?php echo count($done) ?> Phiếu điều phối nhập</p>
