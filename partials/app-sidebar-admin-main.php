            ...
            <div class="dashboard_sidebar_menus">
                <ul class="dashboard_menu_lists">
                    ...
                    <li class="liMainMenu" >
                        ...
                        <ul class="subMenus">
                            <li>
                                ...
                                <a class="subMenuLink" href="phieuxuatkho-tp.php"><i class="fa fa-shield fa-rotate-270"></i>Phiếu xuất kho - Thành phẩm</a>
                            </li>
                        </ul>
                    </li>
                    <li class="liMainMenu" >
                    ...
                    <li class="liMainMenu" >
                        ...
                        <ul class="subMenus">
                            <li>
                                <a class="subMenuLink" href="show-user.php"><i class="fa fa-shield fa-rotate-270"></i>Danh sách user</a>
                                <a class="subMenuLink" href="user-add.php"><i class="fa fa-shield fa-rotate-270"></i>Quản lý user</a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li class="liMainMenu" >
                    ...
                    <li class="liMainMenu" >
                        <a href="javascript:void(0);" class="showHideSubMenu" >
                            ...
                            <span class="menuText showHideSubMenu" >Danh sách kho</span>
                            <i class="fa fa-angle-left mainMenuIconArrow showHideSubMenu" style="float: right;"></i>
                        </a>
                   ...
                   <li class="liMainMenu" >
                        <a href="javascript:void(0);" class="showHideSubMenu" >
                            <i class="fa fa-book fa-fw showHideSubMenu" ></i>
                            <span class="menuText showHideSubMenu" >Phiếu</span>
                            <i class="fa fa-angle-left mainMenuIconArrow showHideSubMenu" style="float: right;"></i>
                        </a>
