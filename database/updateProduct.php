...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $maThanhPham = isset($_POST['maThanhPham']) ? intval($_POST['maThanhPham']) : 0;
    $tenThanhPham = isset($_POST['tenThanhPham']) ? htmlspecialchars($_POST['tenThanhPham']) : null;
    ...
    if ($maThanhPham !== null && $tenThanhPham !== null && $soLuong !== null && $donViTinh !== null) {
        try {
            include("connection.php");

            // Sử dụng prepare statement để tránh SQL injection
            $sql = "UPDATE ThanhPham SET tenThanhPham = :tenThanhPham, soLuong = :soLuong, donViTinh = :donViTinh, trangThai = :trangThai WHERE maThanhPham = :maThanhPham";
