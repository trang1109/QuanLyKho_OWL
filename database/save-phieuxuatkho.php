...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($maLoHang !== null && $soLuongXuat !== null) {
        try {
            ...
            $checkSoLuongSql = "SELECT soLuongNhap FROM lohang WHERE maLoHang = :maLoHang";
            ...
            $insertPhieuXuatKhoSql = "INSERT INTO phieuxuatkho(maPhieuXuatKho, ngayLapPhieu) VALUES (:maPhieuXuatKho, NOW())";
            ...
            $insertCTXuatLoSql = "INSERT INTO chitietxuatlo(maChiTietXuatLo, maLoHang, maPHieuXuatKho, soLuong) 
            ...
            $updateSoLuongChinhSql = "UPDATE lohang 
            ...
            $updateNVL = "UPDATE nguyenvatlieu nv
            SET nv.soLuong = COALESCE((
                SELECT COALESCE(SUM(lh.soLuongChinh), 0)
                FROM lohang lh
                WHERE lh.maNguyenVatLieu = nv.maNguyenVatLieu
