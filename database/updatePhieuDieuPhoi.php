...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($maLoHang !== null && $maKho !== null) {
        try {
            ...
            $updateLohangSql = "UPDATE lohang SET maKho = :maKho, ngayCapNhat=NOW() WHERE maLoHang = :maLoHang";
            ...
            $maPhieuDieuPhoi = time();
            $insertPhieuDieuPhoiSql = "INSERT INTO phieudieuphoi(maPhieuDieuPhoi, ngayLapPhieu, maLoHang, maKho) VALUES (:maPhieuDieuPhoi, NOW(), :maLoHang, :maKho)";
