<?php
    ...
    $nvl = json_encode($nvl);
    $pnks = include_once('database/showLoHang-xem.php');
    $count = include_once('database/countPhieuNhapKho.php');
    $pnks2 = include_once('database/showLoHang-xemtp.php');
    $count2 = include_once('database/countPhieuNhapKhotp.php');
	//echo $name;
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="dashboard_content_container" id="dashboard_content_container">
            ...
            <div class="dashboard_content">
                <div class="row-add">
                            ...
                            <h1>Danh sách phiếu nhập kho nguyên vật liệu</h1>
                            <div class="user">
                                <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($pnks as $index => $pnk){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $pnk['tenNguyenVatLieu'] ?></td>
                                ...
                                <p class="userCount"><?php echo count($count) ?> Phiếu nhập kho nguyên vật liệu</p>
                            </div>
                        </div>
                        <h1>Danh sách phiếu nhập kho thành phẩm</h1>
                            <div class="user">
                                <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($pnks2 as $index => $pnk){ ?>
                                            <tr>
                                ...
                                <p class="userCount"><?php echo count($count2) ?> Phiếu nhập kho thành phẩm</p>
                            </div>
