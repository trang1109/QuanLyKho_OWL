                ...
                <div class="row-add">
                    <div class="column-add column-5">
                        ...
                        <div id="userAddFormContainer">
                            <form action="database/save-bienbankiemke.php" method="post">
                                <h1>Tạo biên bản kiểm kê</h1>
                                <div class="form-group">
                                    <label for="maKho">Chọn kho cần kiểm kê</label><br>
                                    <select  name="maKho" id="maKho" onchange="loadLoHangs()" class="form-control">
                                        <!-- Tùy chọn thành phẩm sẽ được đổ vào đây từ PHP -->
                                        <option>Chọn mã kho</option>
                                        <?php include('database/showKhoCode.php');?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="maLoHang">Chọn Lô Hàng:</label>
                                    <select id="maLoHang" name="maLoHang"  onchange="loadChiTiet()" class="form-control">
                                        <!-- Dữ liệu mã lô hàng sẽ được đổ vào từ JavaScript -->
                                    </select>
                                </div>
                                <div class="form-group" id="chiTietLoHang" class="form-control">
                                    <!-- Dữ liệu mã lô hàng sẽ được đổ vào từ JavaScript -->
                                </div>
                                <div class="form-group">
                                    <label for="">Mô tả kiểm kê</label><br>
                                    <input class="appFormInput"type="text" name="moTaKiemKe" id="moTaKiemKe">
                                </div>
                                <div class="form-group">
                                    <label for="">Số lượng kiểm kê</label><br>
                                    <input class="appFormInput" type="number" name="soLuongKiemKe" id="soLuongKiemKe">
                                </div>
                                <button class="appBtn" type="submit"><i class="fa fa-plus">Tạo</i></button>
                                <button class="appBtnReset" type="reset"><i class="fa fa-refresh"> Reset</i></button>
                            </form>
                            <?php 
