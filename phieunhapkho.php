...
<body>
    ...
    <?php include('partials/if-main.php')?>
        <div class="dashboard_content_container" id="dashboard_content_container">
            ...
            <div class="title">
                <h1>Phiếu Nhập Kho - Nguyên Vật Liệu</h1>
            </div>
                    ...
                    <div class="column-add column-5">
                        <div class="dashboard_content_main">
                            ...
                            <form action="database/save-order.php" method="post" >
                                <h1>Tạo mới phiếu xuất kho  - Nguyên vật liệu</h1>
                                    <div class="alignRight">
                                        <button type="button" class="btn btn-primary" id="orderProductBtn">Add new</button>
                                        <br>
                                        <br>
                                    </div>
                                    <div>
                            ...
                            <div class="user">
                                ...
                                <p class="userCount"><?php echo count($count) ?> Phiếu nhập kho</p>
                            </div>
                        </div>
                            </div>
